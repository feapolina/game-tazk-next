...
- **[Next.js 15](https://nextjs.org/)** - Framework React em sua versão mais recente (utilizando **App Router**)
- **[React 19](https://react.dev/)** - Biblioteca principal de UI
- **[Tailwind CSS v4](https://tailwindcss.com/)** - Estilização dinâmica e eficiente baseada em classes utilitárias
- **[Supabase](https://supabase.com/)** - Backend as a Service (para Banco de Dados PostgreSQL, Autenticação SSR e Storage de Imagens)
- **[Radix UI](https://www.radix-ui.com/)** - Componentes acessíveis
- **[Motion](https://motion.dev/) & [GSAP](https://gsap.com/)** - Animações ricas e fluidas
- **[Lucide React](https://lucide.dev/)** - Ícones
- **[dnd-kit](https://dndkit.com/)** - Sistema de Drag & Drop para a lista de tarefas
